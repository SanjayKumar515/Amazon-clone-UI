                    ...
                    <div>
                            ...
                            <div className="h-[150px] overflow-y-scroll no-scrollbar">
                                <ul className="pl-0 list-none text-[#777777] cursor-pointer capitalize text-[16px] ">
                                    { categories && categories.map( ( cat: Category ) => (
                                        <div onClick={ () => setFilters( { ...filters, category: cat?.id } ) } key={ cat?.id } className="hover:text-black hover:bg-gray-200 dark:text-skin-base dark:hover:text-skin-light bg-opacity-90 my-2">{ cat?.title }</div>
                                ...
                                <div>
                                    <ul className="colors flex flex-wrap gap-2.5 ps-0">
                                        { colors && colors.map( ( each, index ) => (
                                            <input key={ index } readOnly onClick={ () => handleColor( each?.id ) } className={ `w-[23px] h-[23px] focus:border-black border-2 focus: rounded-full cursor-pointer ${ backObj[ each?.title ] }` } />
                                        ) ) }
                                    </ul>
                                </div>
                        ...
                        <div className="  py-[10px] px-[15px]">
                            ...
                            { brands?.map( ( brand: Category ) => (
                                <div key={ brand?.id } className="mb-[0.125rem]  min-h-[1.5rem] pl-[1.5rem]">
                                    <input
                            ...
                            <div>
                                <div className="flex w-full gap-5 items-center border-b py-2 border-[#777777]">
                                    ...
                                    <div className="w-9/12 mb-3">
                                        ...
                                        <span className=" text-skin-base font-[500] text-[1rem] font-Rubik">₹ 1000</span>
                                    </div>
                                </div>
