...
const SingleProductPage = () => {
    ...
    const currItem = cartItems.find( ( item: CartItem ) => item.id === singleProduct!?.id );
    ...
    return (
        ...
        <>
            ...
            <div className="bg-skin-background w-full">
                            ...
                            <section className="block lg:flex gap-5 w-full mt-5">
                                ...
                                <div className="lg:w-1/2 text-skin-base mt-5 lg:mt-0">
                                    ...
                                    <div className="block md:flex items-center">
                                        <span className="text-[1.4rem] font-[450] mr-5 leading-loose">${ singleProduct?.price }</span>
                                        <span className="text-[1.4rem] font-[400] mr-5 leading-loose line-through italic">${ singleProduct!?.price + 0.3 * singleProduct!?.price }</span>
                                    ...
                                    <div className="flex items-center h-fit w-fit">
                                        ...
                                        {/*
                                            Extract the wishlist icon logic into a variable for clarity.
                                        */}
                                        {(() => {
                                            let wishlistIcon;
                                            if (loading) {
                                            ...
                                            } else if (wishlist?.find((id: any) => id?.id === singleProduct?.id)) {
                                                wishlistIcon = (
                                                    <AiFillHeart className="text-red-500 group-hover:text-blue-500 transition-all group-hover:scale-110" size={25} />
                                                );
                                            } else {
                                                wishlistIcon = <AiOutlineHeart size={25} />;
                                            }
                                            return (
                                                <button
                                                    type="button"
                                                    onClick={() => ToWishlist(singleProduct?.id as string)}
                                                    className="cursor-pointer group h-fit transition-all delay-100 hover:bg-pink-600 p-4 bg-gray-300 rounded-md ml-5"
                ...
                <section className="sm:mx-5 my-5 shadow-lg">
                    <CreateReview prodId={ singleProduct?.id as string } />
                </section>
                <section className="sm:mx-5">
