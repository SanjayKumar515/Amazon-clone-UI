                    ...
                    { products.length === 0 ? (
                        ...
                        <div id="empty-wishlist" className="bg-skin-background" style={ { height: '100vh', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative' } }>
                            <div className="empty-wishlist" style={ { display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' } }>
                                ...
                                <h2 className="text-skin-base" style={ { textAlign: 'center', fontSize: '50px', fontWeight: 'bold', fontFamily: 'poppins' } }>No products matches with this filter</h2>
                                <div className="flex">
                        ...
                        <div className="block md:flex gap-5 sm:p-5 ">
                            <div className="md:w-3/12 md:block hidden relative ">
                                ...
                                <div className='sticky top-32 left-0'>
                                    {
                                        closeMenu === true ? (
                                            <div className=" rounded-lg bg-white py-[10px] px-[15px]  mb-3">
