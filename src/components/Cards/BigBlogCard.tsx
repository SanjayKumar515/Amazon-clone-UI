    ...
    return (
        ...
        <section className="max-w-[340px] 400px:max-w-[400px] h-[500px] rounded-md overflow-hidden shadow-lg ">
            ...
            <div className="w-full h-full p-[10px] text-justify relative ">
                ...
                <h6 className="text-skin-base font-semibold line-clamp-1">{ blog?.title }</h6>
                ...
                <Link to={ `/blog/${ blog?.id }` } className="button absolute top-[130px] left-4 my-[10px] text-white text-[0.91rem] px-[25px] py-[6px] rounded-[25px]">
                    Read More
                </Link>
