    ...
    return (
        ...
        <section className=" dark:bg-[#0c1317]  px-5 py-5 border-b">
            ...
            <button
                ...
                className={ `text-sm font-medium mr-5 text-blue-700 hover:underline cursor-pointer bg-transparent border-none p-0 ${ readmore ? "hidden" : "block" } ` }
            ...
            <button
                ...
                className={ `text-sm font-medium mr-5 text-blue-700 hover:underline cursor-pointer bg-transparent border-none p-0 ${ readmore ? "block" : "hidden" } ` }
                style={{ background: "none", border: "none" }}
            >
                read less
            </button>
            <div className="mt-5">
                { rating?.postedBy?.id === user?.id ? (
