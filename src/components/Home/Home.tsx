    ...
    return (
        <div className="max-w-[1300px] m-auto">
            <section className="grid-wrapper rounded-md my-[1rem] shadow-lg">
                ...
                <button
                    type="button"
                    onClick={() => getProducts({ category: '65432ca9ff2dd51bb661f24f' })}
                    className="relative sm:cursor-pointer p-0 border-0 bg-transparent text-left"
                ...
                <button
                    type="button"
                    onClick={() => getProducts({ category: '65320ce235ca026efd0583c8' })}
                    className="relative sm:cursor-pointer p-0 border-0 bg-transparent text-left"
                    style={{ width: '100%', height: '100%' }}
                >
                ...
                <button
                    type="button"
                    onClick={() => getProducts({ category: '65320ce635ca026efd0583cc' })}
                    className="relative sm:cursor-pointer p-0 border-0 bg-transparent text-left"
                    style={{ width: '100%', height: '100%' }}
                >
                ...
                <button
                    type="button"
                    onClick={() => getProducts({ category: '654328a7ff2dd51bb661f0c0' })}
                    className="relative sm:cursor-pointer p-0 border-0 bg-transparent text-left"
                    style={{ width: '100%', height: '100%' }}
                >
